/**
 * Hyundai Vehicle Valuation Seed Script
 * 
 * Source: Hyundai & Kia in Nigeria Comprehensive Price & Valuation Guide (Feb 2026)
 * Extracted from: scripts/import-hyundai-kia-valuations.ts (Hyundai portion)
 * 
 * Usage:
 * - Test with --dry-run: tsx scripts/seeds/hyundai/hyundai-valuations.seed.ts --dry-run
 * - Run: tsx scripts/seeds/hyundai/hyundai-valuations.seed.ts
 * - Force re-run: tsx scripts/seeds/hyundai/hyundai-valuations.seed.ts --force
 * 
 * Features:
...
const SCRIPT_NAME = 'hyundai-valuations';
const BATCH_SIZE = 50;
...
/**
 * Hyundai vehicle valuation data from official Hyundai & Kia guide (Feb 2026)
 * Covers models: Elantra, Sonata, Tucson, ix35, Santa Fe, Creta, Palisade, Veloster, Accent
 */
