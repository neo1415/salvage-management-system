...
export const metadata: Metadata = {
  title: 'Privacy Policy | Salvage Auction Platform',
  description: 'Privacy Policy for the Salvage Auction Platform - NDPA 2023 Compliant',
};
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          <div className="mb-8 pb-6 border-b border-gray-200">
            <h1 className="text-4xl font-bold text-[var(--brand-primary)] mb-2">Privacy Policy</h1>
          ...
          <div className="prose prose-slate max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">1. Introduction</h2>
              <p className="text-gray-700 mb-4">
                {legal.legalName} ("we", "us", or "our") is committed to protecting your personal data and respecting your privacy rights.
                This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use {legal.platformName}.
              </p>
              <p className="text-gray-700 mb-4">
                We comply with the Nigeria Data Protection Act 2023 (NDPA 2023) and the Nigeria Data Protection Regulation (NDPR).
                This policy should be read together with our <Link href="/terms" className="text-[var(--brand-primary)] hover:text-[var(--brand-primary-hover)] underline">Terms of Service</Link> and
                our <Link href="/ndpr" className="text-[var(--brand-primary)] hover:text-[var(--brand-primary-hover)] underline">NDPR Compliance Statement</Link>.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">2. Data Controller Information</h2>
              <div className="bg-gray-50 rounded-lg p-6">
                <p className="text-gray-700 mb-2"><strong>Data Controller:</strong> {legal.legalName}</p>
                <p className="text-gray-700 mb-2"><strong>Address:</strong> {legal.addressLine1}, {legal.addressLine2}</p>
                <p className="text-gray-700 mb-2"><strong>Email:</strong> {legal.privacyEmail}</p>
                <p className="text-gray-700 mb-2"><strong>Data Protection Officer:</strong> {legal.dpoEmail}</p>
                <p className="text-gray-700">Registration Number: {legal.registrationNumber}</p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">3. Personal Data We Collect</h2>

              <h3 className="text-xl font-semibold text-[var(--brand-primary)] mb-3 mt-6">3.1 Information You Provide</h3>
              ...
              <h3 className="text-xl font-semibold text-[var(--brand-primary)] mb-3 mt-6">3.2 Information Collected Automatically</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
                <li><strong>Device Information:</strong> IP address, browser type, device type, operating system</li>
                <li><strong>Usage Data:</strong> Pages visited, time spent, clicks, bids placed</li>
                <li><strong>Location Data:</strong> Approximate location based on IP address</li>
                <li><strong>Cookies:</strong> See our <Link href="/cookies" className="text-[var(--brand-primary)] hover:text-[var(--brand-primary-hover)] underline">Cookie Policy</Link></li>
              </ul>

              <h3 className="text-xl font-semibold text-[var(--brand-primary)] mb-3 mt-6">3.3 Information from Third Parties</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">4. How We Use Your Data</h2>
              <p className="text-gray-700 mb-4">We process your personal data for the following purposes:</p>

              <h3 className="text-xl font-semibold text-[var(--brand-primary)] mb-3 mt-6">4.1 Contract Performance</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-[var(--brand-primary)] mb-3 mt-6">4.2 Legal Compliance</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-[var(--brand-primary)] mb-3 mt-6">4.3 Legitimate Interests</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">5. Data Sharing & Disclosure</h2>
              <p className="text-gray-700 mb-4">We share your data with:</p>

              <h3 className="text-xl font-semibold text-[var(--brand-primary)] mb-3 mt-6">5.1 Service Providers</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
              ...
              <h3 className="text-xl font-semibold text-[var(--brand-primary)] mb-3 mt-6">5.2 Legal Requirements</h3>
              ...
              <h3 className="text-xl font-semibold text-[var(--brand-primary)] mb-3 mt-6">5.3 Business Transfers</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">6. Your Rights Under NDPA 2023</h2>
              ...
              <div className="bg-[var(--brand-primary-surface)] border-l-4 border-[var(--brand-primary)] p-4 my-4">
                <p className="text-[var(--brand-primary)]">
                  <strong>To exercise your rights:</strong> Email {legal.dpoEmail} with your request.
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">7. Data Retention</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">8. Data Security</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">9. International Data Transfers</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">10. Children's Privacy</h2>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">11. Changes to This Policy</h2>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">12. Contact Us</h2>
              <div className="bg-gray-50 rounded-lg p-6">
                <p className="text-gray-700 mb-2"><strong>Privacy Inquiries:</strong> {legal.privacyEmail}</p>
                <p className="text-gray-700 mb-2"><strong>Data Protection Officer:</strong> {legal.dpoEmail}</p>
                <p className="text-gray-700 mb-2"><strong>Phone:</strong> {legal.supportPhone}</p>
