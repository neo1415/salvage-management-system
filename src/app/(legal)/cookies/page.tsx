      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          <div className="mb-8 pb-6 border-b border-gray-200">
            <h1 className="text-4xl font-bold text-[var(--brand-primary)] mb-2">Cookie Policy</h1>
            <p className="text-gray-600">Last Updated: {legal.legalLastUpdated}</p>
          </div>

          <div className="prose prose-slate max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">1. What Are Cookies?</h2>
              <p className="text-gray-700 mb-4">
                Cookies are small text files stored on your device when you visit {legal.platformName}. They help us provide you with
                a better experience by remembering your preferences and understanding how you use our services.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">2. Cookies We Use</h2>

              <h3 className="text-xl font-semibold text-[var(--brand-primary)] mb-3 mt-6">2.1 Essential Cookies (Always Active)</h3>
              ...
              <h3 className="text-xl font-semibold text-[var(--brand-primary)] mb-3 mt-6">2.2 Functional Cookies</h3>
              ...
              <h3 className="text-xl font-semibold text-[var(--brand-primary)] mb-3 mt-6">2.3 Analytics Cookies</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">3. Cookie Duration</h2>
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">4. Managing Cookies</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">5. Third-Party Cookies</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--brand-primary)] mb-4">6. Contact Us</h2>
              <p className="text-gray-700">
                For questions about cookies, contact us at: <a href={`mailto:${legal.privacyEmail}`} className="text-[var(--brand-primary)] hover:text-[var(--brand-primary-hover)] underline">{legal.privacyEmail}</a>
              </p>
            </section>
          </div>
