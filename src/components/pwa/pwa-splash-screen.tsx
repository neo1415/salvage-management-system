...
export function PwaSplashScreen() {
  ...
  return (
    <div
      className="fixed inset-0 z-[10000] flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#800020] via-[#6b001a] to-[#4a0012] transition-opacity duration-[650ms] ease-out"
      aria-hidden
      role="presentation"
    >
