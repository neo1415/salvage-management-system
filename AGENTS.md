...
Use configurable brand values wherever reasonable:

- logo
- appName or brandName
- companyName or legalName
- primaryColor
- accentColor
- supportEmail
- contactPhone

Do not hardcode product names into the template body unless the copy is intentionally supplied by configuration.
...
Use motion only when it improves understanding: soft hero entry, timeline progress, hover depth, status pulse, scroll reveal, and mobile menu transitions. Respect reduced-motion preferences.

Avoid endless bouncing, aggressive parallax, heavy 3D, and motion that blocks reading.

### Media Rules

Default media lives in `public/assets/recovery-command`. It should show salvage yards, damaged vehicles, field inspection, auction lots, or professional operations teams. Do not use luxury-car, rental, dealership, or unrelated mechanic imagery.

### Definition Of Done

The template is complete when it is distinct, premium, responsive, accessible, brand-configurable, credible, and client-facing enough to show as a concept.
